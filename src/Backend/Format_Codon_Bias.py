...
def format_codon_bias(codon_bias_table):
    codons = []
    actual_codon = {'bases':'', 'frequencyper1000':'', 
                    'amount':'', 'mode':'freq'}
...
def create_formatted_codon_bias_from_sequence(sequence):
    codons = []
    codon_counts = {'CGA':0, 'CGC':0, 'CGG':0, 'CGU':0, 'AGA':0, 'AGG':0, 
                    'CUA':0, 'CUC':0, 'CUG':0, 'CUU':0, 'UUA':0, 'UUG':0, 
                    'UCA':0, 'UCC':0, 'UCG':0, 'UCU':0, 'AGC':0, 'AGU':0, 
                    'ACA':0, 'ACC':0, 'ACG':0, 'ACU':0, 'CCA':0, 'CCC':0, 
                    'CCG':0, 'CCU':0, 'GCA':0, 'GCC':0, 'GCG':0, 'GCU':0, 
                    'GGA':0, 'GGC':0, 'GGG':0, 'GGU':0, 'GUA':0, 'GUC':0, 
                    'GUG':0, 'GUU':0, 'AAA':0, 'AAG':0, 'AAC':0, 'AAU':0, 
                    'CAA':0, 'CAG':0, 'CAC':0, 'CAU':0, 'GAA':0, 'GAG':0, 
                    'GAC':0, 'GAU':0, 'UAC':0, 'UAU':0, 'UGC':0, 'UGU':0, 
                    'UUC':0, 'UUU':0, 'AUA':0, 'AUC':0, 'AUU':0, 'AUG':0, 
                    'UGG':0, 'UAA':0, 'UAG':0, 'UGA':0}
    whitelisted_sequence = change_sequence_to_use_only_bases_letters(sequence)
    try:
    ...
    for key, value in codon_counts.items():
        codon_frequency = round(float(value*(len(rewrite_sequence_to_codons(whitelisted_sequence))/1000)), 1)
